<!-- Imagen de portada -->
<p align="center">
  <img src="assets/banner.webp" alt="Star Wars Banner" width="100%" />
</p>

# 💫 Sobre mí

💡 Soy un apasionado por la tecnología y estudiante de Ingeniería en Informática, siempre en busca de nuevos conocimientos y desafíos.  
...
📫 Contacto: [LinkedIn](https://linkedin.com/in/tuusuario) | kevin@email.com
...
```python
class Developer:
    def __init__(self, name, username, location, web):
        self.name = name
    ...
    def portfolio(self):
        return f"Hola, soy {self.name} (@{self.username}), desarrollador de {self.location}. ¡Bienvenido a mi GitHub!"
